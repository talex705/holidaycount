...
export const metadata: Metadata = {
  ...
  description:
    'HolidayCount provides free, live countdown timers for holidays worldwide. Learn about our tools and how we calculate holiday dates.',
    ...
    <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
      ...
      <div className="mt-6 space-y-6 text-gray-700 leading-relaxed">
        <p>
          ...
          worldwide. Whether you are planning a family gathering, counting down the days to a
          long weekend, or simply curious about when the next holiday falls, HolidayCount gives
          you accurate dates and real-time countdowns at a glance.
        </p>
        ...
        <p>
          We cover holidays from 45 countries across North America, Europe, the Caribbean,
          South America, Central America, Africa, and Asia-Pacific. Our database includes over
          150 holidays with full countdown timers, historical background, cultural traditions,
          and planning tips.
        </p>
        ...
        <p>
          While our date calculations follow official rules used by governments worldwide,
          holiday observance can vary by region, employer, or religious tradition. Always verify
          specific holiday dates and closures with your employer or local government.
        </p>
      </div>
    </article>
  );
